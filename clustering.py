...
if EVALUATION:
	print("CMeans function took %0.3f ms" % ((time_cmeans)))
	print("KMeans function took %0.3f ms" % ((time_kmeans)))
	print("KHMeans function took %0.3f ms" % ((time_khmeans)))
